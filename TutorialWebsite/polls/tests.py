...
def create_question(question_text, days):#This is not a test. Its just a function which I can employ in other tests.
    """
    ...
    return Question.objects.create(question_text=question_text, pub_date=time)#Using the create function means you create and save a new question at the same time.




class QuestionIndexViewTests(TestCase):
    def test_no_questions(self):#Creates no test questions and runs the view to check it does what it's supposed to.
        """
        If no questions exist, an appropriate message is displayed.
        """
        response = self.client.get(reverse("polls:index"))#Goes to the url for the index and records the response we receive.
    ...
    def test_past_question(self):
        ...
        self.assertQuerySetEqual(
            ...
            [question],
        )#This is the appropiate way to compare querysets. Apparently when comparing a model to a context, you need to enclose model with brackets (probably to turn it into a queryset).
